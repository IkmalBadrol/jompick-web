            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" action="function/update-jompick.php?resitid=<?php echo $resitid;?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <?php
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class = "form-control" id="jpid" name="jpid" value="<?php echo $jpid; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
                                            <label for="ownername">Item Name: </label>
                                            <input type="text" class="form-control" id="ownername" name="ownername" value="<?php echo $ownername; ?>" required>
                                        </div>
                                    </div>
                                    <?php 
                                        $selecteddoc = " ";
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tnum" name="tnum" value="<?php echo $tnum; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
