            ...
            <div id="content">
                ...
                <h1 class="h3 mb-4 text-gray-800">Manager Profile</h1>
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" action="function/update-manager.php?jpid=<?php echo $jpid;?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <?php
                                ...
                                $sql2 = "SELECT address FROM pickup_location WHERE pickupLocation_id = $userlocation;"; 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cnewpassword" name="cnewpassword" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
