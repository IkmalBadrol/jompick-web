...
if ($statuspayment == 4) {
    $dlt = "UPDATE payment SET paymentStatus_id = 3 WHERE payment_id = '$p_id';"; // Update to "Unpaid"
}

if ($statuspayment == 3) {
    $dlt = "UPDATE payment SET paymentStatus_id = 4 WHERE payment_id = '$p_id';"; // Update to "Paid"
}
