    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div id="resultContainer" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                // Your SQL query
                $sql123 = "SELECT im.JomPick_ID as jpidclient, c.confirmationStatus_id AS status, c.confirmationDate, i.name
                ...
                while ($row = mysqli_fetch_assoc($result123)) {
                    echo '<a class="dropdown-item d-flex align-items-center" href="jompick-list.php">
                            ...
                            <div>
                                <div class="small text-gray-500">' . $row['confirmationDate'] . '</div>
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    <?php 
                        ...
                        $sql_location = "SELECT address FROM pickup_location WHERE pickupLocation_id = '$jp_location_id'";
                        $result_location = $conn->query($sql_location);

                        if ($result_location->num_rows > 0) {
                            $location_row = $result_location->fetch_assoc();
                            $location = $location_row["address"];
                        }
